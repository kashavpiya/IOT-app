...
import showerhead from '../../assets/phoneWifi.png';
import ActionButton from '../../components/ActionButton';

const PSWifi = ({ navigation, route }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <ProgressBar progress={3/8} color={ELECTRIC_BLUE} />
      <View style={styles.content}>
        <Image source={showerhead} style={styles.image} />
        <View style={styles.textContainer}>
          <Text style={styles.mainText}>
            1. Open your phones wifi settings. 
          </Text>
        </View>
        <View style={styles.textContainer}>
          <Text style={styles.mainText}>
            2. Select WiFi starting with PS .
          </Text>
        </View>
        <View style={styles.textContainer}>
          <Text style={styles.mainText}>
            3. Enter default 'powershower' if needed .
          </Text>
          </View>
        {/* <View style={styles.textContainer}>
